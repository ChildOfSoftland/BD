...
namespace BD
{
    public partial class Form5 : Form
    {
        ...
        {
            con.Open();
            string s1 = "SELECT * FROM departments;";
        ...
        private void dataGridView1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            textBoxID_Firm.Text = dataGridView1.CurrentRow.Cells[3].Value.ToString();
        }
        ...
        {
            string s1 = "INSERT INTO departments(Name, CLP, Firms_ID_Firm) VALUES('" + textBoxName.Text + "','" + textBoxCLP.Text + "','" + textBoxID_Firm.Text + "') ";
            MyQuery(s1);
            DGV();
        }
        ...
        {
            string s2 = "DELETE FROM departments WHERE ID_Department = " + int.Parse(textBoxID.Text) + " ";
            MyQuery(s2);
            DGV();
        }
    }
