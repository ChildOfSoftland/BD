...
namespace BD
{
    public partial class Form2 : Form
    {
        ...
        private void dataGridView1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            textBoxNumber.Text = dataGridView1.CurrentRow.Cells[2].Value.ToString();
        }
        ...
        {
            string s1 = "INSERT INTO employees(FIO, PersonnelNumber) VALUES('" + textBoxFIO.Text + "','" + textBoxNumber.Text + "') ";
            MyQuery(s1);
            DGV();
        }
        ...
        {
            string s2 = "DELETE FROM employees WHERE ID_Associate = " + int.Parse(textBoxID.Text) + " ";
            MyQuery(s2);
            DGV();
        }
    }
