...
namespace BD
{
    public partial class Form3 : Form
    {
        ...
        {
            con.Open();
            string s1 = "SELECT * FROM operations;";
        ...
        {
            string s1 = "INSERT INTO operations(Name, Price) VALUES('" + textBoxName.Text + "','" + int.Parse(textBoxPrice.Text) + "') ";
            MyQuery(s1);
            DGV();
        }
        ...
        {
            string s2 = "DELETE FROM operations WHERE ID_Operation = " + int.Parse(textBoxID.Text) + " ";
            MyQuery(s2);
            DGV();
        }
    }
